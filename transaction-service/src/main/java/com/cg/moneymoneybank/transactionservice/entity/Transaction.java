package com.cg.moneymoneybank.transactionservice.entity;
...
public class Transaction {
	...
	public Transaction(Integer accountNumber, Double amount, String transactionType, String transactionDetails) {
		super();
